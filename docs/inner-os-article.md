...
![AI Inner OS - 给 AI 开一条脑内弹幕通道](pi c01-scene-inner-monologue-channel.png)
...
![AI Inner OS Hook 生命周期数据流](./pic/02-flowchart-hook-lifecycle.png)
...
![AI Inner OS Persona 人设切换系统](./pic/03-infographic-persona-system.png)
...
![AI Inner OS 涌现行为](./pic/04-infographic-emergent-behaviors.png)
...
![从工具到搭档的演进光谱](./pic/05-timeline-tool-to-partner.png)
